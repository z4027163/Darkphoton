...
//   reader->AddVariable( "nmhits", &nmhits_c );
   ...
   TString fold[4]={"jpsi0p2","jpsi0p015_sig","upsilon0p2_PVd","upsilon0p03_PVd"};
...
void add_mva(string treepath = "tree_1.root", int year=2018, bool isMC=false) {

   bool debug=false; 
   vector<string> filesToRun;
//   string dirIn="/eos/cms/store/group/phys_exotica/darkPhoton/jakob/newProd/";
   string dirIn="/eos/user/w/wangz/darkphoton/full/";
   string dirOut="/eos/user/w/wangz/darkphoton/";
//   string dirIn="";
