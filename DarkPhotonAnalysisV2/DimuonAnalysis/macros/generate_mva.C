...
float iso_c,dr_n,chi_c,nlayer_c,nmhits_c,nphits_c,IP_c,PVd_c, vtxchi2_c;
...
void MVAread(TMVA::Reader *reader, int type=1){
   ...
   if(type==8||type==9) reader->AddVariable( "nmhits", &nmhits_c );
   ...
   TString fold[10]={"jpsi0p2","jpsi0p2_IP","upsilon0p2","upsilon0p2_IP","upsilon0p2_PVd","upsilon0p05_PVd","upsilon0p03_PVd","mc0p2_noIP","mc0p2_IP","mc0p03_PVd"};
