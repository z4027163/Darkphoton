...
void MVAread(TMVA::Reader *reader, int type=1){
   ...
   if(type<3) reader->AddVariable("PVd",&PVd_c);
   ...
   TString dir;
   if(type==1) dir="/afs/cern.ch/work/w/wangz/DarkPhotonAnalysisV2/MVA/darkphoton/pt4/"+fold[6]+"/";
   else if(type==2) dir="/afs/cern.ch/work/w/wangz/DarkPhotonAnalysisV2/MVA/darkphoton/"+fold[6]+"/";
   else if(type==3) dir="/afs/cern.ch/work/w/wangz/DarkPhotonAnalysisV2/MVA/darkphoton/pt4/"+fold[0]+"/";
   else dir="/afs/cern.ch/work/w/wangz/DarkPhotonAnalysisV2/MVA/darkphoton/"+fold[0]+"/";
...
void generate_test(TString treepath = "2018A/tree_1.root", TString outfilename = "./scoutData4MuonsM70.root"){
  ...
  float m1mva1,m1mva2,m1mva3,m1mva4;
  float m2mva1,m2mva2,m2mva3,m2mva4;
  int pair;
