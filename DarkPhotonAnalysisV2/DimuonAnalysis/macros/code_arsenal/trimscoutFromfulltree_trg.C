...
//   string dirIn="/eos/cms/store/group/phys_exotica/darkPhoton/jakob/newProd/";
   ...
   TTree* outtree = new TTree("tree", "tree");
    ...
    for(int j=0; j<400; j++){
      ...
      massforLimit_trg1_CatA[j] = new TH1D(Form("massforLimit_trg1_CatA%d",j),Form("massforLimit_trg1_CatA%d",j),100,m-(m*0.013*5.),m+(m*0.013*5.));  massforLimit_trg1_CatA[j]->Sumw2();
      massforLimit_trg1_CatB[j] = new TH1D(Form("massforLimit_trg1_CatB%d",j),Form("massforLimit_trg1_CatB%d",j),100,m-(m*0.013*5.),m+(m*0.013*5.));  massforLimit_trg1_CatB[j]->Sumw2();
      massforLimit_trg2_CatA[j] = new TH1D(Form("massforLimit_trg2_CatA%d",j),Form("massforLimit_trg2_CatA%d",j),100,m-(m*0.013*5.),m+(m*0.013*5.));  massforLimit_trg2_CatA[j]->Sumw2();
      massforLimit_trg2_CatB[j] = new TH1D(Form("massforLimit_trg2_CatB%d",j),Form("massforLimit_trg2_CatB%d",j),100,m-(m*0.013*5.),m+(m*0.013*5.));  massforLimit_trg2_CatB[j]->Sumw2();
      massforLimit_trg3_CatA[j] = new TH1D(Form("massforLimit_trg3_CatA%d",j),Form("massforLimit_trg3_CatA%d",j),100,m-(m*0.013*5.),m+(m*0.013*5.));  massforLimit_trg3_CatA[j]->Sumw2();
      massforLimit_trg3_CatB[j] = new TH1D(Form("massforLimit_trg3_CatB%d",j),Form("massforLimit_trg3_CatB%d",j),100,m-(m*0.013*5.),m+(m*0.013*5.));  massforLimit_trg3_CatB[j]->Sumw2();
      massforLimit_trg4_CatA[j] = new TH1D(Form("massforLimit_trg4_CatA%d",j),Form("massforLimit_trg4_CatA%d",j),100,m-(m*0.013*5.),m+(m*0.013*5.));  massforLimit_trg4_CatA[j]->Sumw2();
      massforLimit_trg4_CatB[j] = new TH1D(Form("massforLimit_trg4_CatB%d",j),Form("massforLimit_trg4_CatB%d",j),100,m-(m*0.013*5.),m+(m*0.013*5.));  massforLimit_trg4_CatB[j]->Sumw2();
