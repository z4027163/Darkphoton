...
C
C  OMIT ELW =0: INCLUDE FULL ELECTROWEAK CORRECTIONS (SM)
C           =1: OMIT ALL ELECTROWEAK CORRECTIONS (SM)
C
...
C MCBAR(3):  CHARM MSBAR MASS AT SCALE Q=3 GEV
C MBBAR(MB): BOTTOM MSBAR MASS AT SCALE Q=MBBAR
C MT:        TOP POLE MASS
C MTAU:      TAU MASS
C MMUON:     MUON MASS
