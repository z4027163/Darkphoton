...
void trimscoutMakeTheCardsLMnew(string treepath = "scout_2.root", const char* outfilename = "./scoutData4MuonsM70.root", bool isMC=false) {
 
   vector<string> filesToRun;
   vector<bool> isData;
   string dirIn="/eos/cms/store/group/phys_exotica/darkPhoton/jakob/newProd/2017/ScoutingRunD/ScoutingCaloMuon/crab_20200617_140351/200617_120401/0000/";
   //string dirIn="";
