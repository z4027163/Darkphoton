...
void generateTree(string treepath = "scout_2.root", const char* outfilename = "./scoutData4MuonsM70.root", int era=1, bool isMC=false) {
...
//2018
        ...
        if(era==1) {BSx=0.0845; BSy=-0.0335;}
        if(era==2) {BSx=0.0835; BSy=-0.032;}
        if(era==3) {BSx=0.0845; BSy=-0.032;}
        if(era==4) {BSx=0.0835; BSy=-0.0295;}
        if(era==5) {BSx=0.0965; BSy=-0.066;}
        if(era==6) {BSx=0.097; BSy=-0.064;}
        if(era==7) {BSx=0.096; BSy=-0.0645;}
        if(era==8) {BSx=0.0965; BSy=-0.062;}
...
//2017
        if(era<=4){if(!(l1Result->at(4) || l1Result->at(10) || l1Result->at(11) || l1Result->at(12) || l1Result->at(18) || l1Result->at(19))) continue;}
        else{if(!( l1Result->at(2) || l1Result->at(6) || l1Result->at(7) || l1Result->at(10) || l1Result->at(11) || l1Result->at(13))) continue;}
        if(nvtx<=0) continue;
