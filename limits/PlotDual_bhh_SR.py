...
bkgpdf2 = w.pdf("shapeBkg_bhh_mass_CatAB")
nbhh = w.function("n_exp_binCatAB_proc_bhh_mass").getVal()


print "nbhh_catAB=", nbhh
...
frac2=w.function("n_exp_binCatAB_proc_bhh_mass")
#bkgpdf2.plotOn(frame2, RooFit.LineColor(8), RooFit.Name("new_pdf"),RooFit.Normalization(ndkpi,RooAbsReal.NumEvent))
addpeak = RooAddPdf("peak", "sig+bhh", RooArgList(sigpdf,bkgpdf2),  RooArgList(frac1,frac2))
addpeak.plotOn(frame2, RooFit.LineColor(kOrange+1), RooFit.Name("sig_pdf"), RooFit.Normalization(nsig+nbhh,RooAbsReal.NumEvent))
bkgpdf2.plotOn(frame2, RooFit.LineColor(8), RooFit.Name("bhh_pdf"),RooFit.Normalization(nbhh,RooAbsReal.NumEvent));
...
print "nbhh_CR=",w.function("n_exp_binCR_proc_bhh_mass").getVal()
print "nbhh_catAB=",nbhh
