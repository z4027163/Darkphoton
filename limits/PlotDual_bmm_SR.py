...
os.system("combine -M MultiDimFit -d output_highpvd/dpCard_"+year+"IterV3_m"+file+".txt --algo none --setParameters r=0.0 --setParameterRanges r=0.1,5 --cminDefaultMinimizerStrategy 0  -n SB -m "+mass+" --X-rtd REMOVE_CONSTANT_ZERO_POINT=1 --X-rtd MINIMIZER_freezeDisassociatedParams --cminRunAllDiscreteCombinations --cminDefaultMinimizerTolerance=0.001 --saveWorkspace")
os.system("combine -M MultiDimFit -d output_highpvd/dpCard_"+year+"IterV3_m"+file+".txt --algo none --setParameters r=0.0 --setParameterRanges r=0.001,0.002 --cminDefaultMinimizerStrategy 0  -n Bonly -m "+mass+" --X-rtd REMOVE_CONSTANT_ZERO_POINT=1 --X-rtd MINIMIZER_freezeDisassociatedParams --cminRunAllDiscreteCombinations --cminDefaultMinimizerTolerance=0.001 --saveWorkspace")
...
bkgpdf2 = w.pdf("shapeBkg_bmm_mass_CatAB")
nbmm = w.function("n_exp_binCatAB_proc_bmm_mass").getVal()


print "nbmm_catAB=", nbmm
...
frac2=w.function("n_exp_binCatAB_proc_bmm_mass")
#bkgpdf2.plotOn(frame2, RooFit.LineColor(8), RooFit.Name("new_pdf"),RooFit.Normalization(ndkpi,RooAbsReal.NumEvent))
addpeak = RooAddPdf("peak", "sig+bmm", RooArgList(sigpdf,bkgpdf2),  RooArgList(frac1,frac2))
addpeak.plotOn(frame2, RooFit.LineColor(kOrange+1), RooFit.Name("sig_pdf"), RooFit.Normalization(nsig+nbmm,RooAbsReal.NumEvent))
bkgpdf2.plotOn(frame2, RooFit.LineColor(8), RooFit.Name("bmm_pdf"),RooFit.Normalization(nbmm,RooAbsReal.NumEvent));
...
print "nbmm_CR=",w.function("n_exp_binCR_proc_bmm_mass").getVal()
print "nbmm_catAB=",nbmm
