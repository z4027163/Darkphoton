...
/* old
  ...
  float norm03_dual[2]={23947.6,16625.3};    //dtokpi SR
  float norm3_dual[2]={31819.4,22385.3};     //dtokpi CR
*/
  ...
  float norm_pp_dual[2]={4234,1017};     //dtopipi SR
...
//                if (mass < 3.0) effcuts = 0.03;
		...
		newcardShape << Form("process 		signalModel_generic     bkg_mass      dpp_mass \n");
		newcardShape << Form("process 		0    		1           2    \n");
		newcardShape << Form("rate    		%f  		%f	   %f   \n",
				     effcuts*effgraph->Eval(mass,0,"S")*luminosity*rescale[kk], catA->Integral(),norm_pp_dual[y]);
                if (year[y] == "2017"){
