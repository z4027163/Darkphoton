...
void MultiMakeCardsAndWS_id_CWR(){
  ...
  //INPUT FILE WITH HISTOGRAMS TO FIT BACKGROUND
	...
	//if (year == "2017") file=TFile::Open("/eos/cms/store/group/phys_exotica/darkPhoton/jakob/newProd/2017/ScoutingRunD/mergedHistos_v1.root");
        if (year[y] == "2017"){
          file2=TFile::Open("~/dphist/CWR/id_ptcut35/mergedHistos_jpsi0p015_2017.root"); 
          file=TFile::Open("~/dphist/CWR/id_ptcut20/mergedHistos_jpsi0p015_2017.root");
        }
        else if (year[y] == "2018"){
          file2=TFile::Open("~/dphist/CWR/id_ptcut35/mergedHistos_jpsi0p015_2018.root"); //61.3 fb -1
          file=TFile::Open("~/dphist/CWR/id_ptcut20/mergedHistos_jpsi0p015_2018.root");
        }
...
//                if (mass < 3.0) effcuts = 0.03;
		...
		cout << ".  The numerator is " << countMVA << " and the denominator is " << countNO << "\n"; 
                ...
                if(i<240) triggereff=effgraph1->Eval(mass,0,"S");
