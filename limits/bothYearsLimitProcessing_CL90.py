...
#                        paramLimits = line[15:]
	...
	if (os.path.isfile(fname)):
               ...
               # os.system("combine -M Significance --pvalue output/dpCard_IterV3_m"+m+"_"+d+".txt -m "+m+" -n asympMassIndex_"+d+ " --cminDefaultMinimizerStrategy 0  --setParameters pdf_index_2017=0,pdf_index_2018=0  --rMin -1 --rMax 1") 
                os.system("combine -M AsymptoticLimits output/dpCard_IterV3_m"+m+"_"+d+".txt -m "+m+" -n asympMassIndex_"+d+" --setParameters pdf_index_2017=0,pdf_index_2018=0 --rAbsAcc=0.0001 --rRelAcc=0.0001 --cminDefaultMinimizerStrategy 0 --rMin -1 --rMax 1 --cl 0.9")	
