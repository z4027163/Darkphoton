...
if idx_CR == "2":
    bkgpdf2.plotOn(frame2, RooFit.LineColor(14),RooFit.LineStyle(2), RooFit.LineWidth(4), RooFit.Name("dkk_pdf"),RooFit.Normalization(ndkk,RooAbsReal.NumEvent));
#####/my chi2 calculation
...
leg= TLegend(0.55, 0.75,0.9, 0.85)
leg.SetBorderSize( 0 )
...
Ratio.GetYaxis().SetTitle("Data - Combinatorial Background")
#Ratio.SetMaximum(1200)
...
c1.SaveAs("bump_"+backname+"_"+year+".pdf");
