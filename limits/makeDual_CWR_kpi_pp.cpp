...
//                if (mass < 3.0) effcuts = 0.03;
		...
		newcardShape << Form("process 		signalModel_generic     bkg_mass      dkpi_mass    dpp_mass\n");
		newcardShape << Form("process 		0    		1           2      3\n");
		newcardShape << Form("rate    		%f  		%f	   %f     %f\n",
				     effcuts*effgraph->Eval(mass,0,"S")*luminosity*rescale[kk], catA->Integral(),norm03_dual[y],norm_pp_dual[y]);
                if (year[y] == "2017"){
