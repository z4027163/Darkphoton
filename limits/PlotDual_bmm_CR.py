...
totalpdf = w.pdf("pdf_binCR_nuis")
totalpdf.plotOn(frame, RooFit.LineColor(kOrange+1), RooFit.Name("total_pdf"))

bkgpdf = wb.pdf("pdf_binCR_nuis")
bkgpdf.plotOn(frame, RooFit.LineColor(8), RooFit.Name("new_pdf"));

bkgpdf1 = wb.pdf("shapeBkg_bkg_mass_CR")
bkgpdf1.plotOn(frame, RooFit.LineColor(4), RooFit.Name("new_pdf"));
nbkg=wb.function("n_exp_binCR_proc_bkg_mass").getVal()

bkgpdf2 = wb.pdf("shapeBkg_bmm_mass_CR")
nbmm = wb.function("n_exp_binCR_proc_bmm_mass").getVal()


frame2=m2mu.frame()

frac2=w.function("n_exp_binCR_proc_bmm_mass")
...
h_string4 = year+" noID,0.015<PVd<0.2";
