...
//                if (mass < 3.0) effcuts = 0.03;
		...
		newcardShape << Form("process 		signalModel_generic     bkg_mass      dkk_mass      bkg_mass    dkk_mass\n");
		newcardShape << Form("process 		0    		1           2           1              2\n");
		newcardShape << Form("rate    		%f  		%f	  %f        7660974.000000    %f\n",
				     effcuts*effgraph->Eval(mass,0,"S")*luminosity*rescale[kk], catA->Integral(),norm_dual[y],norm2_dual[y]);
