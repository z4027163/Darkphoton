...
year="2017"
fname = ["1.716_215","1.733_216","1.750_217","1.768_218","1.785_219","1.803_220","1.821_221","1.839_222"]
...
for file in fname:
    ...
    nbkg = w.function("n_exp_binCatAB_proc_bkg_mass").getVal()
    bkgpdf1.plotOn(frame, RooFit.LineColor(4), RooFit.Name("new_pdf_2"),RooFit.Normalization(nbkg,RooAbsReal.NumEvent));
    
    bkgpdf2 = w.pdf("shapeBkg_dkpi_mass_CatAB")
    ndkpi = w.function("n_exp_binCatAB_proc_dkpi_mass").getVal()
    #bkgpdf2.plotOn(frame, RooFit.LineColor(8), RooFit.Name("new_pdf"),RooFit.Normalization(ndkpi,RooAbsReal.NumEvent));
    ...
    h_string4 = year;
    latex4.DrawLatex(0.35,0.87, h_string4);
