...
void makeDual_CWR_5(){
  ...
  int norm_dual[2] = {4450,5450};   //SR   TF=CR/SR=1.10
  int norm2_dual[2]={4900,6000};    //high IP
  int norm_bkg_control[2]={6227472,8223619};
//to add, control norm
...
//                if (mass < 3.0) effcuts = 0.03;
		...
		if (year[y] == "2017"){
		  newcardShape << Form("bkg_norm_2017 rateParam CatAB bkg_mass 1.0\n");
                  ...
                  newcardShape << Form("dpp_norm_2017 rateParam * dpp_mass 1.0 [0.2,5]");
		}
		if (year[y] == "2018"){
		  newcardShape << Form("bkg_norm_2018 rateParam CatAB bkg_mass 1.0\n");
                  ...
                  newcardShape << Form("dpp_norm_2018 rateParam * dpp_mass 1.0 [0.2,5]");
		}
