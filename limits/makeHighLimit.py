...
#if year == "CL90":
#    mg.GetYaxis().SetRangeUser(0.001,5)
...
leg.Draw("same")
c1.SaveAs("limit"+year+"DarkPhoton_high.root")
c1.SaveAs("limit"+year+"DarkPhoton_high.pdf")
c1.SaveAs("limit"+year+"DarkPhoton_high.png")
