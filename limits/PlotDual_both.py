...
for file in fname:
    ...
    bkgpdf3 = w.pdf("shapeBkg_dkpi_mass_CatAB")
    ...
    frac3=w.function("n_exp_binCatAB_proc_dkpi_mass")
    #bkgpdf2.plotOn(frame2, RooFit.LineColor(8), RooFit.Name("new_pdf"),RooFit.Normalization(ndkk,RooAbsReal.NumEvent))
    addpeak = RooAddPdf("peak", "sig+dkk+dkpi", RooArgList(sigpdf,bkgpdf2,bkgpdf3),  RooArgList(frac1,frac2,frac3))
    addpeak.plotOn(frame2, RooFit.LineColor(kOrange+1), RooFit.Name("sig_pdf"), RooFit.Normalization(nsig+ndkk+ndkpi,RooAbsReal.NumEvent))
    bkgpdf2.plotOn(frame2, RooFit.LineColor(8), RooFit.Name("dkk_pdf"),RooFit.Normalization(ndkk,RooAbsReal.NumEvent));
    bkgpdf3.plotOn(frame2, RooFit.LineColor(9), RooFit.Name("dkpi_pdf"),RooFit.Normalization(ndkpi,RooAbsReal.NumEvent));
