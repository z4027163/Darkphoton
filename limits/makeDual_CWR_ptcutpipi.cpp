...
void makeDual_CWR_ptcutpipi(){

  TString year[2] = {"2017","2018"};
  int norm_dual[2] = {300,300};   //SR   TF=CR/SR=1.10
  int norm2_dual[2]={330,330};    //high IP
  int norm_bkg_control[2]={171616,185533};
//to add, control norm
...
//                if (mass < 3.0) effcuts = 0.03;
		...
		newcardShape << Form("shapes signalModel_generic	CatAB dpWorkspace"+year[y]+suff+"_%d.root dpworkspace:signalModel_generic\n",i);
                ...
                newcardShape << Form("shapes dpp_mass highip dpWorkspace"+year[y]+"IterV3_%d_dual2.root dpworkspace:voig_pipi\n",i);
                newcardShape << Form("shapes dpp_mass CatAB dpWorkspace"+year[y]+"IterV3_%d.root dpworkspace:voig_pipi\n",i); 
		newcardShape << Form("bin		CatAB        highip\n");
		newcardShape << Form("observation 	-1.0         -1.0\n");
		newcardShape << Form("bin     		CatAB		CatAB		CatAB	   	highip		highip\n");
		newcardShape << Form("process 		signalModel_generic     bkg_mass      dpp_mass     bkg_mass    dpp_mass\n");
		...
		newcardShape << Form("eff_trig_2018 lnN         %f   -    -    -    -\n", triggSys);
                ...
                newcardShape << Form("dpp_ratio lnN            -    -   1.25  -    -\n");
		...
		if (year[y] == "2017"){
		  newcardShape << Form("bkg_norm_2017 rateParam CatAB bkg_mass 1.0\n");
                  ...
                  newcardShape << Form("dpp_norm_2017 rateParam * dpp_mass 1.0 [0.0,5]");
		}
		if (year[y] == "2018"){
		  newcardShape << Form("bkg_norm_2018 rateParam CatAB bkg_mass 1.0\n");
                  ...
                  newcardShape << Form("dpp_norm_2018 rateParam * dpp_mass 1.0 [0.0,5]");
		}
